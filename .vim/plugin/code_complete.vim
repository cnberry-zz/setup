...
let g:template['c']['cd'] = "/**\<cr>".g:rs."FUNCTION DESCRIPTION".g:re."\<cr>\<cr>".
    \ "@param ".g:rs."PARAMNAME".g:re."      ".g:rs."DESCRIPTION OF PARAMNAME".g:re."\<cr>".
    \ "@param ".g:rs."PARAMNAME".g:re."      ".g:rs."DESCRIPTION OF PARAMNAME".g:re."\<cr>".
    \ "@param ".g:rs."PARAMNAME".g:re."      ".g:rs."DESCRIPTION OF PARAMNAME".g:re."\<cr>".
    \ "@return ".g:rs."return val".g:re."\<cr>\<left>/\<cr>"
...
let g:template['c']['for_h'] = "for_hash( ".g:rs."...".g:re." , ".g:rs."...".g:re." , ".g:rs."...".g:re." )\<cr>{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['for_p'] = "for_ptrhash( ".g:rs."...".g:re." , ".g:rs."...".g:re." , ".g:rs."...".g:re." )\<cr>{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['for_i'] = "for_insts( ".g:rs."...".g:re." , ".g:rs."...".g:re." ) {\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['for_n'] = "for_nets( ".g:rs."...".g:re." , ".g:rs."...".g:re." ) {\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['for_b'] = "for_bitports( ".g:rs."...".g:re." , ".g:rs."...".g:re." ) {\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
...
let g:template['c']['ife'] = "if( ".g:rs."...".g:re." ) {\<cr>".g:rs."...".g:re."\<cr>} else {\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['TEST'] = "TEST( ".g:rs."...".g:re." , ".g:rs."...".g:re." ) {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['T'] = g:template['c']['TEST']
let g:template['c']['TF'] = "TEST_F( ".g:rs."...".g:re." , ".g:rs."...".g:re." ) {\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['TEST_F'] = g:template['c']['TF']
let g:template['c']['Gl'] = "GlobalTestEnv::Create"
